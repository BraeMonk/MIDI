...
function attachKeyEvents(el, note, isBlack) {
  ...
  el.addEventListener('touchstart',  (e) => { e.preventDefault(); _lastTouch = Date.now(); onPress(e); }, { passive: false });
  el.addEventListener('touchend',    (e) => { e.preventDefault(); onRelease(e); }, { passive: false });
...
function buildDrumGrid() {
  ...
  state.padDefs.forEach((def, i) => {
    ...
    el.addEventListener('touchstart', (e) => { e.preventDefault(); _lastTouch = Date.now(); fire(e); }, { passive: false });
